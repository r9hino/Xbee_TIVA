...
#define SHT21_CMD_MEAS_T_HOLD   0xE3        // Measure temperatue with I2C bus hold.
#define SHT21_CMD_MEAS_RH_HOLD  0xE5        // Measure humidity with I2C bus hold.
...
#define SHT21_CONFIG_RES_M      0x81        // Resolution config for temp and hum.
...
#define SHT21_CONFIG_HEATER_M   0x04        // On chip heater for test and diagnostics.
#define SHT21_CONFIG_HEATER_DISABLE   	 0x00  // Heater off.
#define SHT21_CONFIG_HEATER_ENABLE    	 0x04  // Heater on.
#define SHT21_CONFIG_OTP_RELOAD_M     	 0x02  // OTP reload control; soft reset is preferred.
#define SHT21_CONFIG_OTP_RELOAD_ENABLE   0x00     // OTP reload enabled
#define SHT21_CONFIG_OTP_RELOAD_DISABLE  0x02     // OTP reload disabled
#define SHT21_CONFIG_BATT_S     			6
#define SHT21_CONFIG_HEATER_S   			2
#define SHT21_CONFIG_OTP_RELOAD_S    		1
