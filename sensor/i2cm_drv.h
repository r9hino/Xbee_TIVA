...
typedef struct{
    ...
    // The function that is called when the read-modify-write has been completed.
    tSensorCallback *pfnCallback;
...
typedef struct{
    // A pointer to the I2C master interface instance used for the write request.
    tI2CMInstance *psI2CInst;
...
typedef struct{
    // A pointer to the I2C master interface instance used for the read request.
    tI2CMInstance *psI2CInst;
